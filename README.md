...
I explored [increasing atomicity](https://arxiv.org/abs/2604.03436) of BatchTopK SAEs, and [finding belief geometries](https://arxiv.org/abs/2604.02685) outside of tightly defined numeric use cases  -- things like modular arithmetic or geographic distance -- in the representation space of transformers trained on natural language. The [MetaSAE](https://github.com/good-epic/MetaSAE) repo is meant for public reuse. The repo for [finding belief geometries](https://github.com/good-epic/finding-belief-geometries) is research code.
